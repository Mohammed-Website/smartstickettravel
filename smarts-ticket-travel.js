        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/smartstickettravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض طرابزون',
        image_1: ['عروض-شركة-سمارت-تيكت/عروض-طرابزون/عرض-طرابزون-1.jpg', 'اوزنجول & ايدر & زيغانا & همسى كوى & بوزتبة'],
        image_2: ['عروض-شركة-سمارت-تيكت/عروض-طرابزون/عرض-طرابزون-2.jpg', 'اوزنجول & ايدر & زيغانا & همسى كوى & بوزتبة'],
        image_3: ['عروض-شركة-سمارت-تيكت/عروض-طرابزون/عرض-طرابزون-3.jpg', 'اوزنجول & ايدر & زيغانا & همسى كوى & بوزتبة'],
        image_4: ['عروض-شركة-سمارت-تيكت/عروض-طرابزون/عرض-طرابزون-4.jpg', 'اوزنجول & ايدر & زيغانا & همسى كوى & بوزتبة'],
        image_5: ['عروض-شركة-سمارت-تيكت/عروض-طرابزون/عرض-طرابزون-5.jpg', 'اوزنجول & طرابزون - 8 أيام'],
    },

    {
        title: 'عروض جورجيا',
        image_1: ['عروض-شركة-سمارت-تيكت/عروض-جورجيا/عرض-جورجيا-1.jpg', 'جورجيا - تبليسي 7 أيام'],
        image_2: ['عروض-شركة-سمارت-تيكت/عروض-جورجيا/عرض-جورجيا-2.jpg', 'تبليسي & انانوري & جوداوري & متسخيتا & باكورياني & غودري'],
    },
    
    {
        title: 'عروض فرنسا',
        image_1: ['عروض-شركة-سمارت-تيكت/عروض-فرنسا/عرض-فرنسا-1.jpg', 'فرنسا - باريس 5 أيام'],
    },

    {
        title: 'عروض روسيا',
        image_1: ['عروض-شركة-سمارت-تيكت/عروض-روسيا/عرض-روسيا-1.jpg', 'روسيا - سوتشي 8 أيام'],
        image_2: ['عروض-شركة-سمارت-تيكت/عروض-روسيا/عرض-روسيا-2.jpg', 'روسيا - سوتشي 8 أيام'],
    },

    {
        title: 'عروض اسطنبول',
        image_1: ['عروض-شركة-سمارت-تيكت/عروض-اسطنبول/عرض-اسطنبول-1.jpg', 'عرض اسطنبول - 4 أيام'],
    },

    {
        title: 'عروض البوسنة',
        image_1: ['عروض-شركة-سمارت-تيكت/عروض-البوسنة/عرض-البوسنة-1.jpg', 'فيسوكو & زينيتسا & سراييفو'],
    },

    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-سمارت-تيكت/عروض-تايلاند/عرض-تايلاند-1.jpg', 'كرابي & بوكيت & بانكوك'],
        image_2: ['عروض-شركة-سمارت-تيكت/عروض-تايلاند/عرض-تايلاند-2.jpg', 'عرض تايلاند - بوكيت & بانكوك'],
    },

    {
        title: 'عروض سريلانكا',
        image_1: ['عروض-شركة-سمارت-تيكت/عروض-سريلانكا/عرض-سريلانكا-1.jpg', 'دامبولا & كاندي & نوارليا & بنتوتا & كوتومبو'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+97337505515?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/smartstickettravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة سمارت تيكت على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة سمارت تيكت على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة سمارت تيكت على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة سمارت تيكت للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة سمارت تيكت للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة سمارت تيكت`;
            img.title = `مكتب سياحي - شركة سمارت تيكت`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+97337505515";
